...
public class InterestCalculatorDecisionTableTest {
    @ParameterizedTest
    @CsvFileSource(resources = "testcase/InterestCalculatorDecisionTable_validdata.csv", numLinesToSkip = 1)
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "testcase/InterestCalculatorDecisionTable_invaliddata.csv", numLinesToSkip = 1)
